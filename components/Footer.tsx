  ...
  return (
    <Box sx={{ textAlign: "center", my: 4, py: 1, px: 2 }}>
      ...
      <Flex sx={{ alignItems: "center" }}>
        <Box sx={{ flex: "1 1 auto" }} />
        <Flex sx={{ bg: "white", border: "1px solid", alignItems: "center" }}>
          <IconButton
            aria-label="Twitter"
            sx={{ mx: 1, cursor: "pointer" }}
            onClick={() => {
              window.open("https://twitter.com/thedotrip");
            }}
          >
          ...
          <Box sx={{ flex: "1 1 auto", fontSize: "10px", mx: 3 }}>
            <Link href="https://mysterious.technology" variant="nav" sx={{ fontWeight: "normal" }}>
              <Text>mysterious</Text>
              <Text>.technology</Text>
            </Link>
          </Box>
          <Link href="/policies" variant="nav" sx={{ mx: 2, py: 1, fontSize: "12px" }}>
            Policies
          </Link>
        </Flex>
        <Box sx={{ flex: "1 1 auto" }} />
