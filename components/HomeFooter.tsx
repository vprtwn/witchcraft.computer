      ...
      <Flex sx={{ alignItems: "center" }}>
        ...
        >
          {/* <IconButton
            ...
            onClick={() => {
              window.open("https://twitter.com/flexjar");
            }}
          >
          ...
          <Box sx={{ pl: 2, pr: 0, fontWeight: "bold", fontSize: "10px" }}>
            <Link href="https://twitter.com/flexjar" variant="nav">
              <i>@flexjar</i>
            </Link>
          </Box>
          <Text sx={{ fontSize: "10px", ml: 2 }}>by</Text>
          <Box sx={{ flex: "1 1 auto", fontSize: "9px", mx: 2 }}>
